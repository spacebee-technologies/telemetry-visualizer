...
def make_message(operation,body_bits,body_length,j):
    timestamp=0
...
mode_message=make_message(1,mode_byte_representation,mode_bit_length,1)
...
battery_message=make_message(2,battery_byte_representation,battery_byte_length,2)
...
for i in range(0,10,1):
    ...
    accelerometer_message=make_message(3,byte_representation_accelerometer,accelerometer_byte_length,3+i)
